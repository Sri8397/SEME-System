    ...
    return (
        <form className="row g-3" noValidate onSubmit={handleSubmit}>
            <div className="col-md-6">
                ...
                <input type="text" value={credentials.fname} className="form-control" name="fname" onChange={onChange} required />
            ...
            <div className="col-12">
                ...
                <input type="text" className="form-control" value={credentials.address} name="address" onChange={onChange} required />
                <div className="invalid-feedback">
            ...
            <div className="col-md-6">
                ...
                <input type="text" className="form-control" value={credentials.city} name="city" onChange={onChange} required />
                <div className="invalid-feedback">
            ...
            <div className="col-md-4">
                ...
                <select name="state" className="form-select" value={credentials.state} onChange={onChange} required>
            ...
            <div className="col-md-2">
                ...
                <input type="number" className="form-control" value={credentials.pincode} name="pincode" onChange={onChange} required />
                <div className="invalid-feedback">
